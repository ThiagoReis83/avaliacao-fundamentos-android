...
public class ServiceOrderListActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public static final Integer PARAM_ACTIVE = 1;
    public static final Integer PARAM_INACTIVE = 0;
    private RecyclerView mServiceOrders;
    private ServiceOrderListAdapter mServiceOrdersAdapter;
    private Integer mActive = PARAM_ACTIVE;
    ...
    private void updateRecyclerItens() {
        final List<ServiceOrder> serviceOrders = ServiceOrder.getAll(this.mActive);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.actionSearchInatives:
                findOrdersByActive(PARAM_INACTIVE);
                return true;
            case R.id.actionSearchActives:
                findOrdersByActive(PARAM_ACTIVE);
                return true;
            case R.id.actionShare:
                // Create the text message with a string
                final Intent sendIntent = new Intent(Intent.ACTION_SEND);
                sendIntent.putExtra(Intent.EXTRA_TEXT, ServiceOrder.getAll(this.mActive).toString());
    ...
    private void findOrdersByActive(Integer mActive) {
